...
export const metadata: Metadata = {
  title: 'Simulations - AI+1 - Medhavy',
  description: 'Interactive simulations and explorable explanations.',
}

export default function SimulationsPage() {
  const docs = scanFlatCategory(
    join(process.cwd(), 'public', 'ai1', 'simulations'),
    '/ai1/simulations',
    '/ai1/simulations',
  )
  ...
  return (
    <div className="container px-4 md:px-6 mx-auto py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold tracking-tighter mb-4">Simulations</h1>
        <p className="text-muted-foreground mb-10">{docs.length} interactive simulations.</p>

        {docs.length === 0 && <p className="text-sm text-muted-foreground">Simulations coming soon.</p>}
